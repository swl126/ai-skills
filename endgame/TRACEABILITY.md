...
| Test actual outputs | Catalog validator, 80 report-validator cases, 20 worked-report validations, 19 model-evaluation tests, 133 assessment-engine tests, 13 priority-domain tests, 29 repository tests, link audit, JSON parsing, and remote verification | Local commands plus GitHub Actions |
