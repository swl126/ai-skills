...
| Test actual outputs | Catalog validator, 80 report-validator cases, 20 worked-report validations, 19 executable evaluation tests, unit suite, link audit, JSON parsing, and remote verification | Local commands plus GitHub Actions |
