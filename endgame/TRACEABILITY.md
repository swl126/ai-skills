...
| Ingest proposed skills without other repositories | Twenty canonical paths under `skills/` plus `embedded-skills.json` | `scripts/validate_embedded_skills.py` and unit tests |
