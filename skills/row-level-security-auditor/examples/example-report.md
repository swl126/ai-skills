# RLS audit report — worked example

## Decision summary

- **Decision:** CRITICAL: an owner-executed view exposes cross-tenant attachment metadata.
- **Scope and artifact identity:** EXAMPLE-row-level-security-auditor-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Audit project, task, and attachment isolation across tenant and service roles. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | CRITICAL: an owner-executed view exposes cross-tenant attachment metadata. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
