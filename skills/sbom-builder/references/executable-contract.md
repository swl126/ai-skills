# SBOM Validation Engine executable contract
...
The engine requires evidence records for these categories: `artifact`, `components`, `relationships`, `licenses`, `coverage`. Domain thresholds live in `engine-profile.json`, and the input shape is defined by `../schemas/assessment.schema.json`.
