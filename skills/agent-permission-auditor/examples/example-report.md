# Effective-authority review — worked example

## Decision summary

- **Decision:** BLOCK: a shared role permits wildcard identity mutation without a just-in-time approval boundary.
- **Scope and artifact identity:** EXAMPLE-agent-permission-auditor-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Review a deployment agent with source-control, cloud, secrets-manager, and messaging tools. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | BLOCK: a shared role permits wildcard identity mutation without a just-in-time approval boundary. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
