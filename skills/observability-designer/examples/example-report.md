# Observability design — worked example

## Decision summary

- **Decision:** Use completion latency and stuck-job age; page on burn rate and hard age, not queue depth alone.
- **Scope and artifact identity:** EXAMPLE-observability-designer-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Design telemetry for a multi-tenant job service with queue stalls and partial completion. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | Use completion latency and stuck-job age; page on burn rate and hard age, not queue depth alone. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
