# Evaluation report — worked example

## Decision summary

- **Decision:** BLOCK: two indirect-injection canary leaks violate the zero-critical-failure gate.
- **Scope and artifact identity:** EXAMPLE-model-evaluation-harness-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Compare a support-agent candidate with the baseline on accuracy, refusal, injection resistance, latency, and cost. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | BLOCK: two indirect-injection canary leaks violate the zero-critical-failure gate. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
