# Dataset card — worked example

## Decision summary

- **Decision:** SUITABLE WITH LIMITS: historical English issue classification only, not multilingual performance or training.
- **Scope and artifact identity:** EXAMPLE-dataset-documenter-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Document three years of labeled support tickets for model evaluation. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | SUITABLE WITH LIMITS: historical English issue classification only, not multilingual performance or training. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
