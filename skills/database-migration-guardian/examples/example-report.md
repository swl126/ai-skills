# Migration gate and runbook — worked example

## Decision summary

- **Decision:** CONDITIONAL GO: expansion and dual-write pass; contraction remains blocked until old writers reach zero.
- **Scope and artifact identity:** EXAMPLE-database-migration-guardian-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Add a required normalized key to a 200-million-row table while two application versions coexist. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | CONDITIONAL GO: expansion and dual-write pass; contraction remains blocked until old writers reach zero. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
