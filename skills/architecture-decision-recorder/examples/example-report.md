# Architecture decision record — worked example

## Decision summary

- **Decision:** Select managed queues for lower operational burden; revisit at declared throughput and portability thresholds.
- **Scope and artifact identity:** EXAMPLE-architecture-decision-recorder-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Choose managed queues, a self-hosted broker, or the existing database queue. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | Select managed queues for lower operational burden; revisit at declared throughput and portability thresholds. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
