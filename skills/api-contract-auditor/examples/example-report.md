# API contract audit — worked example

## Decision summary

- **Decision:** BREAKING: both changes alter observable behavior for existing generated clients.
- **Scope and artifact identity:** EXAMPLE-api-contract-auditor-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Review a billing API change that replaces nullable totals with omitted fields and changes pagination defaults. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | BREAKING: both changes alter observable behavior for existing generated clients. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
