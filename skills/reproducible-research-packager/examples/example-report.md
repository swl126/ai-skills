# Research reconstruction record — worked example

## Decision summary

- **Decision:** PASS WITH RESTRICTION: public fixtures reconstruct structure; numeric claims need authorized source data.
- **Scope and artifact identity:** EXAMPLE-reproducible-research-packager-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Package a quantitative study using restricted survey data and an open analysis pipeline. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | PASS WITH RESTRICTION: public fixtures reconstruct structure; numeric claims need authorized source data. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
