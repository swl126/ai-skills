# Privacy impact assessment — worked example

## Decision summary

- **Decision:** REDESIGN: inferred performance data is disproportionate and creates high-impact employment risk.
- **Scope and artifact identity:** EXAMPLE-privacy-impact-assessor-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Assess workforce analytics inferred from location and communication metadata. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | REDESIGN: inferred performance data is disproportionate and creates high-impact employment risk. | medium | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
