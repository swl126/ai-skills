# Release decision record — worked example

## Decision summary

- **Decision:** BLOCK: irreversible financial state lacks representative rehearsal and verified recovery.
- **Scope and artifact identity:** EXAMPLE-release-readiness-gate-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Gate a payment release with passing unit tests, a flaky integration suite, and an unrehearsed backfill. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | BLOCK: irreversible financial state lacks representative rehearsal and verified recovery. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
