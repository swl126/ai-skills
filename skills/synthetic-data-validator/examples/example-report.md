# Synthetic-data validation report — worked example

## Decision summary

- **Decision:** REJECT: aggregate utility passes, but near-neighbor risk concentrates in two rare subgroups.
- **Scope and artifact identity:** EXAMPLE-synthetic-data-validator-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Validate synthetic claims data for external analytics without exposing rare patient combinations. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | REJECT: aggregate utility passes, but near-neighbor risk concentrates in two rare subgroups. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
