# Synthetic Data Engine executable contract
...
The engine requires evidence records for these categories: `structure`, `distributions`, `utility`, `duplicates`, `membership`, `subgroups`, `decision`. Domain thresholds live in `engine-profile.json`, and the input shape is defined by `../schemas/assessment.schema.json`.
