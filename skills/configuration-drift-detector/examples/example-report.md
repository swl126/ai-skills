# Configuration drift report — worked example

## Decision summary

- **Decision:** CRITICAL DRIFT: production audit logging is false; restore it and verify event delivery.
- **Scope and artifact identity:** EXAMPLE-configuration-drift-detector-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Compare declared configuration with staging and production while excluding volatile deployment IDs. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | CRITICAL DRIFT: production audit logging is false; restore it and verify event delivery. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
