# Redacted secrets review — worked example

## Decision summary

- **Decision:** HIGH: validity is uncertain; revoke first, rotate consumers, and retain only redacted evidence.
- **Scope and artifact identity:** EXAMPLE-secrets-hygiene-auditor-v1
...
| --- | --- | --- | --- | --- |
| E-1 | Sanitized scenario fixture v1 | Review a repository after a cloud key was suspected in an old CI artifact. | Frozen example input | Does not represent a live system |
...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | HIGH: validity is uncertain; revoke first, rotate consumers, and retain only redacted evidence. | high | E-1, E-2 | Resolve the named condition and rerun the same acceptance check | Example owner | Before promotion |
